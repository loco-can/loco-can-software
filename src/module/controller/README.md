# LOCO-Controller
The LOCO-Controller function is used in the Universal and Universal-WiFi modules to create a driving console. It can directly be plugged into the Universal Control Adapter that provides JST-connectors for input and ouput devices.
...
blinking: 1/2 time on every second 
fast blinking: 1/2 time on every 500ms
light: steady on
