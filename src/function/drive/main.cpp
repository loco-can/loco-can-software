 ...
 */
void FUNCTION_DRIVE::begin(void) {
...
void FUNCTION_DRIVE::update(void) {

}


void FUNCTION_DRIVE::stop(void) {

	digitalWrite(DRIVE_FORW, LOW);
	digitalWrite(DRIVE_REV, LOW);
	digitalWrite(DRIVE_BREAK, LOW);
	digitalWrite(DRIVE_PWM, LOW);
}


void FUNCTION_DRIVE::forw(void) {
...
void FUNCTION_DRIVE::drive(void) {
	digitalWrite(DRIVE_BREAK, LOW);
}


void FUNCTION_DRIVE::brk(void) {
	digitalWrite(DRIVE_BREAK, HIGH);
}



void FUNCTION_DRIVE::set_pwm(uint16_t val) {
	// analogWrite(PWM, val);
...
void FUNCTION_DRIVE::ledc_init(void) {
